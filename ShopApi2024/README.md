...
docker login
docker tag spd221-asp-api:latest borys1994/spd221-asp-api:latest
docker push borys1994/spd221-asp-api:latest

docker pull borys1994/spd221-asp-api:latest
docker ps -a
docker run -d --restart=always --name spd221-asp_container -p 5391:8080 borys1994/spd221-asp-api
...
docker stop spd221-asp_container
docker rm spd221-asp_container
docker rmi borys1994/spd221-asp-api:latest
