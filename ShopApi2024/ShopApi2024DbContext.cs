...
{
    public class ShopApi2024DbContext : IdentityDbContext <UserEntity,RoleEntity,int>
    {
        //private readonly IWebHostEnvironment environment;
        public ShopApi2024DbContext()
        {
        ...
        public ShopApi2024DbContext(DbContextOptions options) : base(options)
        {
            //this.environment = environment;
            //this.Database.EnsureDeleted();
            //this.Database.EnsureCreated();
